...
states <- subset(all_states, region %in% "california" )

plot = ggplot() + geom_polygon(data = states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) + geom_point( data=tweets_shiny, aes(x=longitude, y=latitude, color = sentiment, alpha = .1))
...
renderPlotly({
  ggplotly() + geom_polygon(data = states, aes(x=long, y=lat, group = group),colour="white", fill="grey10" ) + geom_point( data=tweets_shiny, aes(x=longitude, y=latitude))
})
```
